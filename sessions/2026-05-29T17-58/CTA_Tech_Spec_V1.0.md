<title>CTA & 사회적 증명 디자인 에셋 기술 명세서 (Tech Spec V1.0)</title><version>V1.0</version><date>2026-05-29</date><metadata><source_file>CTA_Optimization_ABTest_Spec_V1.0.md</source_file><designer_kit>Design_to_Code_Handoff_Kit_V2.0.md</designer_kit><status>Production Ready Spec</status></metadata><section id="1. 목적">
